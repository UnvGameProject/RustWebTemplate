...
const APP_CSS: Asset = asset!("generated/app.css");
const PLAIN_CSS: Asset = asset!("assets/css/app.css");
const BOOTSTRAP_JS: Asset = asset!("generated/bootstrap.bundle.min.js");
    ...
    Ok(view! {
        ...
        <html lang="en" data-bs-theme="dark">
            <head>
                ...
                topcoat::dev::script() //TODO: will throw a console error in dev. 
            </head>
            <body>
                (slot)
            </body>
        ...
        <main class="poc-shell d-flex align-items-center py-5">
            <div class="container py-5">
                <div class="d-flex flex-wrap align-items-center gap-2 mb-4">
                    <span class="badge rounded-pill text-bg-success">"POC 0 - Rendering"</span>
                    <span class="text-secondary small">"Topcoat 0.8.1 | Rust 1.98 | Bootstrap 5.3.8 | Docker"</span>
                </div>
                    ...
                    <aside class="col-lg-4">
                        <div class="poc-panel card shadow-lg">
                            <div class="card-body p-4">
                                <h2 class="h4 card-title">"POC acceptance gates"</h2>
                                <div class="vstack gap-3 mt-4">
                                    <div class="border rounded-3 p-3">
                                        <div class="fw-semibold">"1. Frontend velocity"</div>
                                        <div class="small text-secondary mt-1">"Layouts, components, forms, reactive UX, CSS/SCSS freedom, and maintainability."</div>
                                    </div>
                                    <div class="poc-security-note border rounded-3 p-3">
                                        <div class="fw-semibold">"2. Application security"</div>
                                        <div class="small text-secondary mt-1">"Laravel-grade defaults or explicit, tested Rust replacements for every missing guardrail."</div>
                                    </div>
                                    <div class="border rounded-3 p-3">
                                        <div class="fw-semibold">"3. Operational simplicity"</div>
                                        <div class="small text-secondary mt-1">"Reproducible Docker builds, minimal runtime dependencies, logging, tests, and deployability."</div>
                                    </div>
                                </div>
                            </div>
                        </div>
